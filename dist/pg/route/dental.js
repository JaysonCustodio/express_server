...
dental.delete("/admin/patient/:id", interceptor_1.default, admin_1.default.deletePatient);
dental.delete("/admin/accounts/:id", interceptor_1.default, admin_1.default.deleteAccount);
dental.post("/admin/accounts", interceptor_1.default, admin_1.default.addtAccount);
dental.post("/admin/patientrecord", interceptor_1.default, admin_1.default.addPatientMedicalRecord);
dental.post("/admin/api/sms", interceptor_1.default, admin_1.default.sendMessage);
dental.post("/admin/treatmentrecord", interceptor_1.default, admin_1.default.addTreatmentRecord);
...
dental.get("/admin/billing", interceptor_1.default, admin_1.default.getAllTreatmentRecord);
dental.get("/admin/treatmentrecord/:id", interceptor_1.default, admin_1.default.getTreatmentRecord);
